...
/***/ function(module, exports, __webpack_require__) {
	...
	var Numpad = function (_PapapaFramework) {
	    ...
	    _createClass(Numpad, [{
	        key: 'popup',
	        value: function popup() {
	            _get(Numpad.prototype.__proto__ || Object.getPrototypeOf(Numpad.prototype), 'popup', this).call(this);
	            console.log(222);
	        }
	    }, {
	        key: '_willPopUp',
	        value: function _willPopUp() {}
	    }, {
	        key: '_didPopUp',
	        value: function _didPopUp() {}
	    }, {
	        key: '_willFold',
	        value: function _willFold() {}
	    }, {
	        key: '_didFold',
	        value: function _didFold() {}
	    }, {
	        key: '_keyDown',
